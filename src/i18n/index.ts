...
const translations = {
  zh: {
    ...
    settings: {
      ...
      apiUrl: 'API 地址',
      apiKey: 'API 密钥',
      apiUrlHint: '留空走内置代理；公司内网也可直连 api.msh.team',
      apiKeyHint: '公网部署请填 kimi.com/code/console 的 Kimi Code Key；内网可留空',
      model: '模型',
      modelHint: '留空使用默认模型 kimi-k2.6（K2.7 Code 关闭思考）',
  ...
  en: {
    ...
    settings: {
      ...
      apiUrl: 'API URL',
      apiKey: 'API Key',
      apiUrlHint: 'Leave empty to use the built-in proxy; on the intranet you can also use api.msh.team directly',
      apiKeyHint: 'For public deployment, paste your Kimi Code key from kimi.com/code/console; leave empty on intranet',
      model: 'Model',
      modelHint: 'Leave empty to use the default model kimi-k2.6 (K2.7 Code, thinking off)',
